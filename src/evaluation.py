...
def nearest_neighbours(word: str, E_norm: np.ndarray, idx2word: list, word2idx: dict, n: int = 10,
...
def analogy(a: str, b: str, c: str, E_norm: np.ndarray, idx2word: list, word2idx: dict, n: int = 5,
) -> list[tuple[str, float]]:
    """
...
def load_google_analogy(path: str) -> dict[str, list]:
    """
    Parse the Google Analogy Benchmark.
    Returns:
        dict mapping category name -> list of (a, b, c, d)
    """
...
def evaluate_analogy_benchmark(E_norm: np.ndarray, idx2word: list, word2idx: dict, categories: dict[str, list],
) -> dict:
    """
    Run the Google Analogy Benchmark.
    Returns:
        dict with:
